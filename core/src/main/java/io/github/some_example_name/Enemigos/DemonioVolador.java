...
public class DemonioVolador extends Enemigo {
    ...
    public DemonioVolador(Float x, Float y, Luchador luchador, Piso piso){
        super(x, y, luchador, piso);
        atlas = new TextureAtlas("Enemigos/demonioVolador.atlas");
        setX(x);
        setY(y);
        setANCHO(70F);
        setALTO(70F);
    ...
    public void inicializarFrames(){
        frames.add(atlas.findRegion("demonioVolador1"));
        frames.add(atlas.findRegion("demonioVolador2"));
    }
