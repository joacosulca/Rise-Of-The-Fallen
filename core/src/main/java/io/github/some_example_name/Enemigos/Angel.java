...
public class Angel extends Enemigo {
    ...
    public Angel(Float x, Float y, Luchador luchador, Piso piso){
        super(x, y, luchador, piso);
        atlas = new TextureAtlas("Enemigos/angel.atlas");
        setX(x);
        setY(y);
        setANCHO(80F);
        setALTO(80F);
    ...
    public void inicializarFrames(){
        frames.add(atlas.findRegion("angel1"));
        frames.add(atlas.findRegion("angel2"));
    }
