...
public class HipogrifoVolador extends Enemigo {
    ...
    public HipogrifoVolador(Float x, Float y, Luchador luchador, Piso piso) {
        super(x, y, luchador, piso);
        atlas = new TextureAtlas("Enemigos/Hipogrifo.atlas");
        inicializarFrames();
        ANCHO = 120F;
        ALTO = 90F;
        velocidadX = 0F;
    ...
    public void inicializarFrames(){
        frames.add(atlas.findRegion("Hipogrifo1"));
        frames.add(atlas.findRegion("Hipogrifo2"));
        frames.add(atlas.findRegion("Hipogrifo3"));
        frames.add(atlas.findRegion("Hipogrifo4"));
        frames.add(atlas.findRegion("Hipogrifo5"));
